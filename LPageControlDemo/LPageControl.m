...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.currentDotBorderColor = [UIColor blackColor];
        self.currentDotWidth = 2;
...
- (void)setCurrentPage:(int)currentPage {
    ...
    if (currentPage > self.currentPage) {
        ...
        [UIView animateWithDuration:0.3 animations:^{
            ...
            endView.layer.borderWidth = self.currentDotBorderWidth;
            endView.layer.borderColor = self.currentDotBorderColor.CGColor;
